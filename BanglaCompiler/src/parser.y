...
%token NUMBER FLOAT STRING BOOL IF ELSE WHILE FOR FUNCTION RETURN PRINT INPUT
%token ASSIGN SEMICOLON LPAREN RPAREN LBRACE RBRACE GT LT EQ PLUS MINUS MUL DIV AND OR
%token <ival> INTEGER
%token <fval> FLOATVAL
